...
#define IMG_CURRTABLE_DATATYPE  1   //图像->世界坐标转换表数据精确度定义
/*
DATATYPE分为精确数据和模糊数据
...
extern uint8 img_EdgeInfo[IMG_H][5];//图像边界信息
    //[0]：左边界 [1]：右边界 [2]：中线 [3]：获取到的边界信息 [4]：斜率\曲率

extern uint8 world_EdgeInfo[IMG_H][5];//世界边界信息
    //[0]：左边界 [1]：右边界 [2]：中线 [3]：获取到的边界信息 [4]：斜率\曲率
...
extern uint8 img_ColEdgeInfo[IMG_W][6];//图像边界信息
    //[0]：行上边界 [1]：行下边界 [2]：中线 [3]：获取到的边界信息 [4]：斜率\曲率 [5]：列位置

extern uint8 world_ColEdgeInfo[IMG_W][6];//世界边界信息
    //[0]：行上边界 [1]：行下边界 [2]：中线 [3]：获取到的边界信息 [4]：斜率\曲率 [5]：列位置
