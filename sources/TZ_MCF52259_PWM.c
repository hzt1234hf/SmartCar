...
void TPWMx_INIT(uint8 mode){
    ...
    MCF_PWM_PWMPRCLK = MCF_PWM_PWMPRCLK_PCKA(3) | MCF_PWM_PWMPRCLK_PCKB(3);//A时钟设置为预分频2^7 = 10000000
	...
	switch(mode){
        ...
        case 4:case 5:{
            ...
            MCF_PWM_PWMCLK |= MCF_PWM_PWMCLK_PCLK4 | MCF_PWM_PWMCLK_PCLK5;  //PWM4通道都用A/B时钟组
            ...
            MCF_PWM_PWMCNT4 = 0;
            MCF_PWM_PWMCNT5 = 0;
            MCF_PWM_PWMPER4 = 50000>>8;
            MCF_PWM_PWMPER5 = 50000&0xff;
            MCF_PWM_PWMDTY4 = 3250>>8;
            MCF_PWM_PWMDTY5 = 3250&0xff;
            MCF_PWM_PWMSCLA = 1;//
